...
//!	This interface exists purely to give client code the ability to detect all WebAPI-specific exception classes in one go.
//!	The purpose of this behaviour is that instances of Aurora::Addon::WebAPI::Exception will be more or less "safe" for public consumption.
	interface Exception extends Addon\Exception{
	}

//!	WebAPI-specific RuntimeException
	class RuntimeException extends Addon\RuntimeException implements Exception{
	}

//!	WebAPI-specific InvalidArgumentException
	class InvalidArgumentException extends Addon\InvalidArgumentException implements Exception{
	}

//!	WebAPI-specific UnexpectedValueException
	class UnexpectedValueException extends Addon\UnexpectedValueException implements Exception{
	}

//!	WebAPI-specific LengthException
	class LengthException extends Addon\LengthException implements Exception{
	}

//!	WebAPI-specific BadMethodCallException
...
//!	Now you might think this class should be a singleton loading config values from constants instead of a registry method, but Marv has plans. MUAHAHAHAHA.
	class WebAPI extends abstractAuthDigestAPI{
...
*/
		public function GridTexture($uuid){
			...
			return $this->get_grid_info('WebAPIHandlerTextureServer') . '/index.php?' . http_build_query(array( 'method'=>'GridTexture', 'uuid'=>$uuid));
		}

//!	Returns the URI for a region texture
/**
*	@param object $region instance of Aurora::Addon::WebAPI::GridRegion
*	@return string full URL to texture
*/
		public function MapTexture(WebAPI\GridRegion $region){
...
/**
*	WebAPI has a call for this so we don't have to spend bandwidth on curling the texture.
*	@param string $uuid texture UUID
...
/**
*	@return Aurora::Addon::WebAPI::OnlineStatus
*	@see Aurora::Addon::WebAPI::makeCallToAPI()
*/
		public function OnlineStatus(){
			...
			return new WebAPI\OnlineStatus($result->Online, $result->LoginEnabled);
		}

//!	object an instance of Aurora::Addon::WebAPI::GridInfo
		protected $GridInfo;
...
//!	Processes should not be long-lasting, so we only fetch this once.
		public function get_grid_info($info=null){
			if(isset($this->GridInfo) === false){
				...
				$this->GridInfo = WebAPI\GridInfo::f();
...
*	@return object An instance of Aurora::Addon::WebAPI::GridUserInfo corresponding to the UUID returned by the API end point.
*/
		public function CreateAccount($Name, $Password, $Email='', $HomeRegion='', $userLevel=0, $RLDOB='1970-01-01', $RLFirstName='', $RLLastName='', $RLAddress='', $RLCity='', $RLZip='', $RLCountry='', $RLIP=''){
			...
			if(Globals::i()->registrationActivationRequired === true){
				$expectedResponse['WebAPIActivationToken'] = array('string' => array());
			}
			...
			if(preg_match(self::regex_UUID, $result->UUID) === false){
				...
				if(preg_match(self::regex_UUID, $result->WebAPIActivationToken) !== 1){
					throw new UnexpectedValueException('Call to API was successful, but activation token was not a valid UUID.');
				}else{
					$ActivationToken = $result->WebAPIActivationToken;
				}
			}
...
/**
*	@return an instance of Aurora::Addon::WebAPI::AvatarArchives corresponding to the result returned by the API end point.
*/
		public function GetAvatarArchives(){
			...
			foreach($result->names as $k=>$v){
				$archives[] = new WebAPI\basicAvatarArchive($v, $result->snapshot[$k]);
			}

			return new WebAPI\AvatarArchives($archives);
		}
...
*/
		private function doLogin($username, $password, $asAdmin=false){
			...
			return WebAPI\genUser::r($result->UUID, $result->FirstName, $result->LastName); // we're leaving validation up to the genUser class.
		}
...
/**
*	If $uuid is an instance of Aurora::Addon::WebAPI::abstractUser, $name is set to Aurora::Addon::WebAPI::abstractUser::Name() and $uuid is set to Aurora::Addon::WebAPI::abstractUser::PrincipalID()
*	@param mixed $uuid either the account ID or an instance of Aurora::Addon::WebAPI::abstractUser
*	@param mixed $name either a string of the account name or NULL when $uuid is an instance of Aurora::Addon::WebAPI::abstractUser
*	@param string $email Email address for the account
*	@param mixed $RLInfo either an instance of Aurora::Addon::WebAPI::RLInfo or NULL
...
*/
		public function EditUser($uuid, $name=null, $email='', WebAPI\RLInfo $RLInfo=null, $userLevel=null){
			if($uuid instanceof WebAPI\abstractUser){
			...
			if($RLInfo instanceof WebAPI\RLInfo){
...
//!	Validator array to be used with Aurora::Addon::WebAPI::makeCallToAPI()
/**
...
*	@return array Validator array to be used with Aurora::Addon::WebAPI::makeCallToAPI()
*	@see Aurora::Addon::WebAPI::GetGridUserInfo()
*	@see Aurora::Addon::WebAPI::RecentlyOnlineUsers()
*/
...
/**
*	@param mixed $uuid either a string UUID of the user we wish to check, or an instance of Aurora::Services::Interfaces::User
*	@return object Aurora::Addon::WebAPI::GridUserInfo
*/
...
/**
*	If $name is an instance of Aurora::Addon::WebAPI::abstractUser, $uuid will be set to Aurora::Addon::WebAPI::abstractUser::PrincipalID() and $name will be set to an empty string.
*	@param mixed $name Either a string of the account name, or an instance of Aurora::Addon::WebAPI::abstractUser
*	@param string $uuid Account UUID
*	@return object instance of Aurora::Addon::WebAPI::UserProfile
*/
		public function GetProfile($name='', $uuid='00000000-0000-0000-0000-000000000000'){
			if($name instanceof WebAPI\abstractUser){
			...
			return WebAPI\UserProfile::r($account->PrincipalID, $account->Name, $account->Email, $account->Created, $allowPublish, $maturePublish, $wantToMask, $wantToText, $canDoMask, $canDoText, $languages, $image, $aboutText, $firstLifeImage, $firstLifeAboutText, $webURL, $displayName, isset($account->PartnerUUID) ? $account->PartnerUUID : '00000000-0000-0000-0000-000000000000', $visible, $customType, $notes, $userLevel, $userFlags, $accountFlags, $RLName, $RLAddress, $RLZip, $RLCity, $RLCountry);
		}

//!	Attempt to delete the user
/**
*	If $uuid is an instance of Aurora::Addon::WebAPI::abstractUser, $uuid is set to Aurora::Addon::WebAPI::abstractUser::PrincipalID()
*	@param mixed $uuid Either an account UUID, or an instance of Aurora::Addon::WebAPI::abstractUser
...
/**
*	This method is only here for completeness, in practice Aurora::Addon::WebAPI::BanUser() should be called with $until specified
*	If $uuid is an instance of Aurora::Addon::WebAPI::abstractUser, $uuid is set to Aurora::Addon::WebAPI::abstractUser::PrincipalID()
*	If $until is an instance of DateTime, $until is set to DateTime::format('c')
*	@param mixed $uuid Either an account UUID, or an instance of Aurora::Addon::WebAPI::abstractUser
...
*	@return object an instance of Aurora::Addon::WebAPI::SearchUserResults
*/
		public function FindUsers($query='', $start=0, $count=25, $asArray=false){
			...
			$has = WebAPI\SearchUserResults::hasInstance($this, $query);
			$results = array();
			...
			if($asArray == true || $has === false){
				...
				foreach($result->Users as $userdata){
					$results[] = WebAPI\SearchUser::r($userdata->PrincipalID, $userdata->UserName, $userdata->Created, $userdata->UserFlags, $userdata->UserLevel, $userdata->Flags);
				}
			}


			return $asArray ? $results : WebAPI\SearchUserResults::r($this, $query, $start, $has ? null : $result->Total, $results);
		}

//!	returns the friends list for the specified user.
/**
*	@param mixed $forUser Either a UUID string or an instance of Aurora::Addon::WebAPI::abstractUser
*	@return object instance of Aurora::Addon::WebAPI::FriendsList
*/
		public function GetFriends($forUser){
			if(($forUser instanceof WebAPI\abstractUser) === false){
			...
			foreach($result->Friends as $v){
				...
				$response[] = WebAPI\FriendInfo::r($forUser, $v->PrincipalID, $v->Name, $v->MyFlags, $v->TheirFlags);
			}

			return new WebAPI\FriendsList($response);
		}
...
*/
		public function RecentlyOnlineUsers($secondsAgo=0, $stillOnline=false, $start=0, $count=10, $asArray=false){
			...
			return $asArray ? $users : WebAPI\RecentlyOnlineUsersIterator::f($this, $secondsAgo, $stillOnline, $start, $result->Total, $users);
		}
...
/**
*	@return array Validator array to be used with Aurora::Addon::WebAPI::makeCallToAPI()
*	@see Aurora::Addon::WebAPI::GetAbuseReports()
*	@see Aurora::Addon::WebAPI::GetAbuseReport()
*/
...
*/
		public function GetAbuseReports($start=0, $count=25, $active=true){
			...
			foreach($result->AbuseReports as $AR){
				$results[] = WebAPI\AbuseReport::r($AR);
			}

			return new WebAPI\AbuseReports($results);
		}
...
*/
		public function GetAbuseReport($id){
			...
			return WebAPI\AbuseReport::r($this->makeCallToAPI('GetAbuseReport', true, array(
					'AbuseReport' => $id
				), array(
...
/**
*	@param mixed $abuseReport Either an integer corresponding to Aurora::Addon::WebAPI::AbuseReport::Number() or an instance of Aurora::Addon::WebAPI::AbuseReport
...
*/
		public function AbuseReportMarkComplete($abuseReport){
			if($abuseReport instanceof WebAPI\AbuseReport){
...
//!	Gets the array used as the expected response parameter for Aurora::Addon::WebAPI::makeCallToAPI()
/**
*	@return array
*/
...
*/
		private static function EstateSettingsFromResult(\stdClass $Estate){
			return WebAPI\EstateSettings::r(
				$Estate->EstateID,
				$Estate->EstateName,
...
*	@return object instance of Aurora::Addon::WebAPI::EstateSettingsIterator
*/
		public function GetEstates($Owner, array $boolFields=null){
			if(($Owner instanceof WebAPI\abstractUser) === false){
			...
			return new WebAPI\EstateSettingsIterator($result);
		}
...
*	@param integer $start start point. If Aurora::Addon::WebAPI::GetRegions is primed, then Aurora::Addon::WebAPI::GetRegions::r() will auto-seek to start.
...
*	@param boolean $asArray controls whether to return an iterator object or a raw result array.
*	@return mixed If $asArray is TRUE returns an array, otherwise returns an instance of Aurora::Addon::WebAPI::GetRegions
*	@see Aurora::Addon::WebAPI::makeCallToAPI()
*	@see Aurora::Addon::WebAPI::fromEndPointResult()
*	@see Aurora::Addon::WebAPI::GetRegions::r()
*/
		public function GetRegions($flags=null, $excludeFlags=null, $start=0, $count=10, $sortRegionName=null, $sortLocX=null, $sortLocY=null, $asArray=false){
			...
			$has = WebAPI\GetRegions::hasInstance($this, $flags, $excludeFlags, $sortRegionName, $sortLocX, $sortLocY);
			if($asArray === true || $has === false){
				...
				foreach($result->Regions as $val){
					$response[] = WebAPI\GridRegion::fromEndPointResult($val);
				}
			}

			return $asArray ? $response : WebAPI\GetRegions::r($this, $flags, $excludeFlags, $start, $has ? null : $result->Total, $sortRegionName, $sortLocX, $sortLocY, $response);
		}
...
*	@return object returns an instance of Aurora::Addon::WebAPI::GetRegions, although may return a child class later
*/
		public function GetRegionsByXY($x, $y, $flags=null, $excludeFlags=null, $scopeID='00000000-0000-0000-0000-000000000000'){
			...
			return WebAPI\GetRegionsByXY::r($this, $x, $y, $flags, isset($excludeFlags) ? $excludeFlags : 0, $scopeID, $response);
		}
...
*/
		public function GetRegionsInArea($startX, $startY, $endX, $endY, $scopeID='00000000-0000-0000-0000-000000000000', $asArray=false){
			$has      = WebAPI\GetRegionsInArea::hasInstance($this, $startX, $startY, $endX, $endY, $scopeID);
			$response = array();
			if($asArray === true || $has === false){
			...
			return $asArray ? $response : WebAPI\GetRegionsInArea::r($this, $startX, $startY, $endX, $endY, $scopeID, 0, $result->Total, $response);
		}
...
*	@param mixed $sortLocY flag for sorting by y-axis coordinates NULL or boolean where TRUE indicates ascending sort and FALSE indicates descending sort.
*	@param boolean $asArray controls whether to return an iterator object or a raw result array.
*	@return mixed If $asArray is TRUE returns an array, otherwise returns an instance of Aurora::Addon::WebAPI::GetRegionsInEstate
*	@see Aurora::Addon::WebAPI::makeCallToAPI()
*	@see Aurora::Addon::WebAPI::fromEndPointResult()
*	@see Aurora::Addon::WebAPI::GetRegions::r()
*/
		public function GetRegionsInEstate(WebAPI\EstateSettings $Estate, $flags=null, $start=0, $count=null, $sortRegionName=null, $sortLocX=null, $sortLocY=null, $asArray=false){
			if(isset($flags) === false){
				$flags = RegionFlags::RegionOnline;
			}
			if(is_bool($asArray) === false){
			...
			$has = WebAPI\GetRegions::hasInstance($this, $Estate, $flags, $sortRegionName, $sortLocX, $sortLocY);
			if($asArray === true || $has === false){
				$result = $this->makeCallToAPI('GetRegions', true, $input, array(
					'Regions' => array('array'=>array(static::GridRegionValidator())),
					'Total'   => array('integer'=>array())
			...
			return $asArray ? $response : WebAPI\GetRegionsInEstate::r($this, $Estate, $flags, 0, $start, $has ? null : $result->Total, $sortRegionName, $sortLocX, $sortLocY, $response);
		}
...
*/
		public function GetRegion($region, $scopeID='00000000-0000-0000-0000-000000000000'){
			...
			return WebAPI\GridRegion::fromEndPointResult($this->makeCallToAPI('GetRegion', true, $input, array(
...
*	@param boolean $asArray controls whether to return an iterator object or a raw result array.
*	@return object returns an instance of Aurora::Addon::WebAPI::GetRegionNeighbours
*/
		public function GetRegionNeighbours($region, $range=128, $scopeID='00000000-0000-0000-0000-000000000000', $start=0, $asArray=false){
			...
			$response = array();
			$has = WebAPI\GetRegionNeighbours::hasInstance($this, $region, $range=128, $scopeID='00000000-0000-0000-0000-000000000000');
			if($asArray === true || $has === false){
			...
			return $asArray ? $response : WebAPI\GetRegionNeighbours::r($this, $region, $range=128, $scopeID='00000000-0000-0000-0000-000000000000', $start, $has ? null : $result->Total, $response);
		}
...
/**
*	@return array The validator array to be passed to Aurora::Addon::WebAPI::makeCallToAPI() when making parcel-related calls.
*/
...
//!	Converts an API result for parcels to an instance of Aurora::Addon::WebAPI::LandData
/**
*	@param object $result API result
*	@return object instance of Aurora::Addon::WebAPI::LandData
*/
...
*	@return mixed Either an array of Aurora::Addon::WebAPI::LandData or an instance of Aurora::Addon::WebAPI::GetParcelsByRegion
*/
		public function GetParcelsByRegion($start=0, $count=10, WebAPI\GridRegion $region, $owner='00000000-0000-0000-0000-000000000000', $scopeID='00000000-0000-0000-0000-000000000000', $asArray=false){
			if(is_string($start) === true && ctype_digit($start) === true){
				$start = (integer)$start;
			}
			if(is_string($count) === true && ctype_digit($count) === true){
			...
			return $asArray ? $result->Parcels : WebAPI\GetParcelsByRegion::r($this, $start, $result->Total, $region, $owner, $scopeID, $result->Parcels);
		}
...
*	@param mixed $region Either NULL when $parcel is a UUID, or an instance of Aurora::Addon::WebAPI::GridRegion
*	@param string $scopeID Region ScopeID
*	@return object instance of Aurora::Addon::WebAPI::LandData
*/
		public function GetParcel($parcel, WebAPI\GridRegion $region=null, $scopeID='00000000-0000-0000-0000-000000000000'){
...
*	@param string $scopeID Region scope ID
*	@param boolean $asArray if TRUE return array of parcels, if FALSE return Iterator object
*	@return mixed Either an array of Aurora::Addon::WebAPI::LandData or an instance of Aurora::Addon::WebAPI::GetParcelsWithNameByRegion
*/
		public function GetParcelsWithNameByRegion($start=0, $count=10, $name, WebAPI\GridRegion $region, $scopeID='00000000-0000-0000-0000-000000000000', $asArray=false){
			if(is_string($start) === true && ctype_digit($start) === true){
				$start = (integer)$start;
			}
			if(is_string($count) === true && ctype_digit($count) === true){
			...
			return $asArray ? $result->Parcels : WebAPI\GetParcelsWithNameByRegion::r($this, $start, $result->Total, $name, $region, $scopeID, $result->Parcels);
		}
...
//!	Converts an instances of stdClass from Aurora::Addon::WebAPI::GetGroups() and Aurora::Addon::WebAPI::GetGroup() results to an instance of Aurora::Addon::WebAPI::GroupRecord
/**
*	@param object $group instance of stdClass with group properties
*	@return object corresponding instance of Aurora::Addon::WebAPI::GroupRecord
*/
...
//!	Enables or disables the specified group as a news source for WebAPI
/**
*	Throws an exception on failure, for laziness :P
*	@param object $group instance of Aurora::Addon::WebAPI::GroupRecord
*	@param boolean $useAsNewsSource TRUE to enable, FALSE to disable
*	@return boolean TRUE if successful, FALSE otherwise
*/
		public function GroupAsNewsSource(WebAPI\GroupRecord $group, $useAsNewsSource=true){
...
*	@param integer $count Maximum number of groups to fetch from the WebAPI API end-point.
...
*	@param array $boolFields optional array of field names for keys and booleans for values, indicating 1 and 0 for field values.
*	@return object Aurora::Addon::WebAPI::GetGroupRecords
*	@see Aurora::Addon::WebAPI::GetGroupRecords::r()
*/
		public function GetGroups($start=0, $count=10, array $sort=null, array $boolFields=null){
			...
			return WebAPI\GetGroupRecords::r($this, $result->Start, $result->Total, $sort, $boolFields, $groups);
		}
...
*	@param integer $count Maximum number of groups to fetch from the WebAPI API end-point
*	@param boolean $asArray if TRUE will return results as an array, otherwise will return an instance of Aurora::Addon::WebAPI::GetNewsSources
*	@return mixed either an array of Aurora::Addon::WebAPI::GroupRecord or an instance of Aurora::Addon::WebAPI::GetNewsSources
*/
		public function GetNewsSources($start=0, $count=10, $asArray=false){
			...
			$response = array();
			if($asArray === true || WebAPI\GetNewsSources::hasInstance($this) === false){
			...
			return $asArray ? $response : WebAPI\GetNewsSources::r($this, $start, $result->Total, $response);
		}

//!	Fetches the specified group
/**
*	@param string $nameOrUUID Either a group UUID, or a group name.
*	@return mixed either FALSE indicating no group was found, or an instance of Aurora::Addon::WebAPI::GroupRecord
*	@see Aurora::Addon::WebAPI::GroupRecord::r()
*/
...
*	@return object Aurora::Addon::WebAPI::foreknowledgeGetGroupRecords
*/
		public function foreknowledgeGetGroupRecords(array $GroupIDs){
			...
			return WebAPI\foreknowledgeGetGroupRecords::r($this, $result->Start, $result->Total, null, null, $groups);
		}
...
//!	PHP doesn't do const arrays :(
/**
*	@return array The validator array to be passed to Aurora::Addon::WebAPI::makeCallToAPI() when making group notice-related calls.
*/
...
/**
*	@param integer $start start point of iterator. negatives are supported (kinda).
*	@param integer $count Maximum number of group notices to fetch from the WebAPI API end-point.
*	@param array $groups instances of GroupRecord
*	@param boolean $asArray controls whether to return an iterator object or a raw result array.
*	@return object instance of Aurora::Addon::WebAPI::GetGroupNotices
*/
		public function GroupNotices($start=0, $count=10, array $groups, $asArray=false){
			$groupIDs = array();
			foreach($groups as $group){
				if($group instanceof WebAPI\GroupRecord){
					$groupIDs[] = $group->GroupID();
				}else if(is_bool($group) === false){
					throw new InvalidArgumentException('Groups must be an array of Aurora::Addon::WebAPI::GroupRecord instances');
				}
			}
			...
			foreach($result->GroupNotices as $groupNotice){
				$groupNotices[] = WebAPI\GroupNoticeData::r(
					$groupNotice->GroupID,
			...
			return $asArray ? $groupNotices : WebAPI\GetGroupNotices::r($this, $start, $result->Total, $groupIDs, $groupNotices);
		}
...
*	@param integer $count Maximum number of group notices to fetch from the WebAPI API end-point.
*	@param boolean $asArray controls whether to return an iterator object or a raw result array.
*	@return mixed if $asArray is FALSE instance of Aurora::Addon::WebAPI::GetGroupNotices, otherwise returns the raw result array
*/
		public function NewsFromGroupNotices($start=0, $count=10, $asArray=false){
			...
			return $asArray ? $groupNotices : WebAPI\GetNewsFromGroupNotices::r($this, $start, $result->Total, array(), $groupNotices);
		}

//!	Get individual group notice
/**
*	@param string $uuid UUID of the group notice you wish to fetch
*	@return object Instance of Aurora::Addon::WebAPI::GroupNoticeData
*/
		public function GetGroupNotice($uuid){
			...
			return WebAPI\GroupNoticeData::r(
				$groupNotice->GroupID,
				$groupNotice->NoticeID,
				$groupNotice->Timestamp,
				$groupNotice->FromName,
...
//!	Edit a group notice
/**
*	@param mixed $notice Either the UUID of a group notice, or an instance of Aurora::Addon::WebAPI::GroupNoticeData
...
*/
		public function EditGroupNotice($notice, $subject=null, $message=null){
			...
			if($notice instanceof WebAPI\GroupNoticeData){
...
/**
*	@param mixed $group Either the UUID of a group, or an instance of Aurora::Addon::WebAPI::GroupRecord
...
//!	PHP doesn't do const arrays :(
/**
*	@return array The validator array to be passed to Aurora::Addon::WebAPI::makeCallToAPI() when making event-related calls.
*/
...
*	@param boolean $asArray controls whether to return an iterator object or a raw result array.
*	@return object instance of Aurora::Addon::WebAPI::GetEvents
*/
		public function GetEvents($start=0, $count=10, array $filter=null, array $sort=null, $asArray=false){
			...
			return $asArray ? $events : WebAPI\GetEvents::r($this, $start, $result->Total, $filter, $sort, $events);
		}
...
*	@return object Instance of Aurora::Addon::WebAPI::EventData
*/
		public function CreateEvent(WebAPI\abstractUser $creator, WebAPI\GridRegion $region, DateTime $date, $cover, $maturity, $eventFlags, $duration, Vector3 $localPos, $name, $description, $category){
...
namespace{
	require_once('WebAPI/abstracts.php');

	require_once('WebAPI/GridInfo.php');
	require_once('WebAPI/Regions.php');
	require_once('WebAPI/Parcels.php');
	require_once('WebAPI/User.php');
	require_once('WebAPI/Group.php');
	require_once('WebAPI/Events.php');

	require_once('WebAPI/AbuseReports.php');
	require_once('WebAPI/AvatarArchives.php');
	require_once('WebAPI/Friends.php');
}

//!	Code specific to the WebAPI
namespace Aurora\Addon\WebAPI{
...
//!	singleton method.
/**
*	@return object an instance of Aurora::Addon::WebAPI::Configs
*/
...
//!	Shorthand method for getting the default instance of Aurora::Addon::WebAPI without having to call Aurora::Addon::WebAPI::reset() all the time.
/**
*	@return object an instance of Aurora::Addon::WebAPI
*/
...
//!	Restricts offsets to integers and values to instances of Aurora::Addon::WebAPI
		public function offsetSet($offset, $value){
			if(($value instanceof \Aurora\Addon\WebAPI) === false){
				throw new InvalidArgumentException('Only instances of Aurora::Addon::WebAPI can be added to instances of Aurora::Addon::WebAPI::Configs');
