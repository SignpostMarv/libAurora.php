<?php
//!	@file Aurora/Addon/WebAPI/Parcels.php
//!	@brief Parcel-related WebAPI code
//!	@author SignpostMarv
...
//!	@see Aurora::Addon::WebAPI::LandData::RegionID()
		protected $RegionID;
//!	@see Aurora::Addon::WebAPI::LandData::$RegionID
...
//!	@see Aurora::Addon::WebAPI::LandData::GlobalID()
		protected $GlobalID;
//!	@see Aurora::Addon::WebAPI::LandData::$GlobalID
...
//!	@see Aurora::Addon::WebAPI::LandData::LocalID()
		protected $LocalID;
//!	@see Aurora::Addon::WebAPI::LandData::$LocalID
...
//!	@see Aurora::Addon::WebAPI::LandData::SalePrice()
		protected $SalePrice;
//!	@see Aurora::Addon::WebAPI::LandData::$SalePrice
...
//!	@see Aurora::Addon::WebAPI::LandData::UserLocation()
...
//!	@see Aurora::Addon::WebAPI::LandData::UserLookAt()
...
//!	@see Aurora::Addon::WebAPI::LandData::Name()
		protected $Name;
//!	@see Aurora::Addon::WebAPI::LandData::$Name
...
//!	@see Aurora::Addon::WebAPI::LandData::Description()
...
//!	@see Aurora::Addon::WebAPI::LandData::Flags()
		protected $Flags;
//!	@see Aurora::Addon::WebAPI::LandData::$Flags
...
//!	@see Aurora::Addon::WebAPI::LandData::Dwell()
		protected $Dwell;
//!	@see Aurora::Addon::WebAPI::LandData::$Dwell
...
//!	@see Aurora::Addon::WebAPI::LandData::InfoUUID()
		protected $InfoUUID;
//!	@see Aurora::Addon::WebAPI::LandData::$InfoUUID
...
//!	@see Aurora::Addon::WebAPI::LandData::AuctionID()
		protected $AuctionID;
//!	@see Aurora::Addon::WebAPI::LandData::$AuctionID
...
//!	@see Aurora::Addon::WebAPI::LandData::Area()
		protected $Area;
//!	@see Aurora::Addon::WebAPI::LandData::$Area
...
//!	@see Aurora::Addon::WebAPI::LandData::Maturity()
		protected $Maturity;
//!	@see Aurora::Addon::WebAPI::LandData::$Maturity
...
//!	@see Aurora::Addon::WebAPI::LandData::OwnerID()
		protected $OwnerID;
//!	@see Aurora::Addon::WebAPI::LandData::$OwnerID
...
//!	@see Aurora::Addon::WebAPI::LandData::GroupID()
		protected $GroupID;
//!	@see Aurora::Addon::WebAPI::LandData::$GroupID
...
//!	@see Aurora::Addon::WebAPI::LandData::IsGroupOwned()
...
//!	@see Aurora::Addon::WebAPI::LandData::SnapshotID()
...
//!	@see Aurora::Addon::WebAPI::LandData::MediaDescription()
...
//!	@see Aurora::Addon::WebAPI::LandData::MediaWidth()
...
//!	@see Aurora::Addon::WebAPI::LandData::MediaHeight()
...
//!	@see Aurora::Addon::WebAPI::LandData::MediaLoop()
		protected $MediaLoop;
//!	@see Aurora::Addon::WebAPI::LandData::$MediaLoop
...
//!	@see Aurora::Addon::WebAPI::LandData::MediaType()
		protected $MediaType;
//!	@see Aurora::Addon::WebAPI::LandData::$MediaType
...
//!	@see Aurora::Addon::WebAPI::LandData::ObscureMedia()
...
//!	@see Aurora::Addon::WebAPI::LandData::ObscureMusic()
...
//!	@see Aurora::Addon::WebAPI::LandData::MediaLoopSet()
...
//!	@see Aurora::Addon::WebAPI::LandData::MediaAutoScale()
...
//!	@see Aurora::Addon::WebAPI::LandData::MediaURL()
		protected $MediaURL;
//!	@see Aurora::Addon::WebAPI::LandData::$MediaURL
...
//!	@see Aurora::Addon::WebAPI::LandData::MusicURL()
		protected $MusicURL;
//!	@see Aurora::Addon::WebAPI::LandData::$MusicURL
...
//!	@see Aurora::Addon::WebAPI::LandData::Bitmap()
		protected $Bitmap;
//!	@see Aurora::Addon::WebAPI::LandData::$Bitmap
...
//!	@see Aurora::Addon::WebAPI::LandData::Category()
		protected $Category;
//!	@see Aurora::Addon::WebAPI::LandData::$Category
...
//!	@see Aurora::Addon::WebAPI::LandData::FirstParty()
...
//!	@see Aurora::Addon::WebAPI::LandData::ClaimDate()
		protected $ClaimDate;
//!	@see Aurora::Addon::WebAPI::LandData::$ClaimDate
...
//!	@see Aurora::Addon::WebAPI::LandData::ClaimPrice()
...
//!	@see Aurora::Addon::WebAPI::LandData::LandingType()
...
//!	@see Aurora::Addon::WebAPI::LandData::PassHours()
		protected $PassHours;
//!	@see Aurora::Addon::WebAPI::LandData::$PassHours
...
//!	@see Aurora::Addon::WebAPI::LandData::PassPrice()
		protected $PassPrice;
//!	@see Aurora::Addon::WebAPI::LandData::$PassPrice
...
//!	@see Aurora::Addon::WebAPI::LandData::AuthBuyerID()
...
//!	@see Aurora::Addon::WebAPI::LandData::OtherCleanTime()
...
//!	@see Aurora::Addon::WebAPI::LandData::RegionHandle()
...
//!	@see Aurora::Addon::WebAPI::LandData::isPrivate()
		protected $isPrivate;
//!	@see Aurora::Addon::WebAPI::LandData::$isPrivate
...
//!	@see Aurora::Addon::WebAPI::LandData::GenericData()
...
*	@param string $Bitmap Bitmap WebAPI will get this as a space-separated list of hexadecimal digits, rather than the raw bitmap
...
*	@param string $RegionHandle Region Handle - in the c#, this is a 64bit unsigned integer. since we can't guarantee availability of 64bit integers (never mined the lack of unsigned integers in PHP), WebAPI will get this as a string.
...
*/
		protected function __construct(
			...
			}else if(preg_match(WebAPI::regex_UUID, $RegionID) != 1){
			...
			}else if(preg_match(WebAPI::regex_UUID, $GlobalID) != 1){
			...
			}else if(preg_match(WebAPI::regex_UUID, $InfoUUID) != 1){
			...
			}else if(preg_match(WebAPI::regex_UUID, $OwnerID) != 1){
			...
			}else if(preg_match(WebAPI::regex_UUID, $GroupID) != 1){
			...
			}else if(preg_match(WebAPI::regex_UUID, $SnapshotID) != 1){
			...
			}else if(preg_match(WebAPI::regex_UUID, $AuthBuyerID) != 1){
...
*	@param mixed $Bitmap NULL or string Bitmap WebAPI will get this as a space-separated list of hexadecimal digits, rather than the raw bitmap
...
*	@param mixed $RegionHandle NULL or string Region Handle - in the c#, this is a 64bit unsigned integer. since we can't guarantee availability of 64bit integers (never mined the lack of unsigned integers in PHP), WebAPI will get this as a string.
...
*/
		public static function r(
			...
			}else if(preg_match(WebAPI::regex_UUID, $InfoUUID) === false){
...
//!	Abstract iterator for instances of Aurora::Addon::WebAPI::LandData
...
/**
*	@param object $WebAPI instanceof Aurora::Addon::WebAPI
*	@param integer $start start point
*	@param integer $total total number of LandData results according to child-class filters
*	@param array $parcels array of Aurora::Addon::WebAPI::LandData objects
*/
		protected function __construct(WebAPI $WebAPI, $start=0, $total=0, array $parcels=null){
			...
			if(isset($parcels) === true){
				...
				foreach($parcels as $parcel){
					if($parcel instanceof LandData){
						...
						throw new InvalidArgumentException('Only instances of Aurora::Addon::WebAPI::LandData should be passed to Aurora::Addon::WebAPI::abstractSeekableLandDataIterator::__construct()');
					}
				}
			}
		}
...
//!	object instance of Aurora::Addon::WebAPI::GridRegion
		protected $region;
...
*	@param array $parcels array of Aurora::Addon::WebAPI::LandData objects
*/
		protected function __construct(WebAPI $WebAPI, $start=0, $total=0, GridRegion $region, $scopeID='00000000-0000-0000-0000-000000000000', array $parcels=null){
			if(is_string($scopeID) === false){
				throw new InvalidArgumentException('ScopeID must be specified as string.');
			}else if(preg_match(WebAPI::regex_UUID, $scopeID) != 1){
				throw new InvalidArgumentException('ScopeID must be valid UUID.');
			}

			parent::__construct($WebAPI, $start, $total, $parcels);
			$this->region  = $region;
			$this->scopeID = $scopeID;
		}
	}

//!	Iterator for geting instances of Aurora::Addon::WebAPI::LandData by parcel owner and region
...
*	@param array $parcels array of Aurora::Addon::WebAPI::LandData objects
*/
		protected function __construct(WebAPI $WebAPI, $start=0, $total=0, GridRegion $region, $owner='00000000-0000-0000-0000-000000000000', $scopeID='00000000-0000-0000-0000-000000000000', array $parcels=null){
			if(is_string($owner) === false){
				throw new InvalidArgumentException('OwnerID must be specified as string.');
			}else if(preg_match(WebAPI::regex_UUID, $owner) != 1){
				throw new InvalidArgumentException('OwnerID must be valid UUID.');
			...
			parent::__construct($WebAPI, $start, $total, $region, $scopeID, $parcels);
			$this->owner = $owner;
		}
...
*	@param string $scopeID Region ScopeID
*	@param array $parcels array of Aurora::Addon::WebAPI::LandData objects
*	@return object instance of Aurora::Addon::WebAPI::GetParcelsByRegion
*/
		public static function r(WebAPI $WebAPI, $start=0, $total=0, GridRegion $region, $owner='00000000-0000-0000-0000-000000000000', $scopeID='00000000-0000-0000-0000-000000000000', array $parcels=null){
			if(is_string($owner) === false){
				throw new InvalidArgumentException('OwnerID must be specified as string.');
			}else if(preg_match(WebAPI::regex_UUID, $owner) != 1){
				throw new InvalidArgumentException('OwnerID must be valid UUID.');
			...
			if($create === true){
				$registry[$hash1][$hash2][$scopeID][$owner] = new static($WebAPI, $start, $total, $region, $owner, $scopeID, $parcels);
			}
...
//!	To avoid slowdowns due to an excessive amount of curl calls, we populate Aurora::Addon::WebAPI::GetParcelsByRegion::$data in batches of 10
/**
*	@return mixed either NULL or an instance of Aurora::Addon::WebAPI::LandData
*/
		public function current(){
			if($this->valid() === false){
				...
				$start   = $this->key();
				$results = $this->WebAPI->GetParcelsByRegion($start, 10, $this->region, $this->owner, $this->scopeID);
...
//!	Iterator for geting instances of Aurora::Addon::WebAPI::LandData by parcel name and region
...
*	@param array $parcels array of Aurora::Addon::WebAPI::LandData objects
*/
		protected function __construct(WebAPI $WebAPI, $start=0, $total=0, $name='', GridRegion $region, $scopeID='00000000-0000-0000-0000-000000000000', array $parcels=null){
			if(is_string($name) === true){
				$name = trim($name);
			}
...
*	@return object instance of Aurora::Addon::WebAPI::GetParcelsByRegion
*/
		public static function r(WebAPI $WebAPI, $start=0, $total=0, $name='', GridRegion $region, $scopeID='00000000-0000-0000-0000-000000000000', array $parcels=null){
			if(is_string($name) === true){
				$name = trim($name);
			}
			...
			if($create === true){
				$registry[$hash1][$hash2][$scopeID][$name] = new static($WebAPI, $start, $total, $name, $region, $scopeID, $parcels);
			}
...
//!	To avoid slowdowns due to an excessive amount of curl calls, we populate Aurora::Addon::WebAPI::GetParcelsWithNameByRegion::$data in batches of 10
/**
*	@return mixed either NULL or an instance of Aurora::Addon::WebAPI::LandData
*/
		public function current(){
			if($this->valid() === false){
				...
				$start   = $this->key();
				$results = $this->WebAPI->GetParcelsWithNameByRegion($start, 10, $this->name, $this->region, $this->scopeID, true);
				foreach($results as $group){
					$this->data[$start++] = $group;
				}
			}
