<?php
//!	@file Aurora/Addon/WebAPI/Events.php
//!	@brief Event-related WebAPI code
//!	@author SignpostMarv
...
//!	integer Event ID
//!	@see Aurora::Addon::WebAPI::EventData::eventID()
		protected $eventID;
//!	@see Aurora::Addon::WebAPI::EventData::eventID
...
//!	string Creator UUID
//!	@see Aurora::Addon::WebAPI::EventData::creator()
		protected $creator;
//!	@see Aurora::Addon::WebAPI::EventData::creator
...
//!	@see Aurora::Addon::WebAPI::EventData::name()
		protected $name;
//!	@see Aurora::Addon::WebAPI::EventData::name
...
//!	@see Aurora::Addon::WebAPI::EventData::category()
		protected $category;
//!	@see Aurora::Addon::WebAPI::EventData::category
...
//!	@see Aurora::Addon::WebAPI::EventData::description()
...
//!	@see Aurora::Addon::WebAPI::EventData::date()
		protected $date;
//!	@see Aurora::Addon::WebAPI::EventData::date
...
//!	@see Aurora::Addon::WebAPI::EventData::duration()
		protected $duration;
//!	@see Aurora::Addon::WebAPI::EventData::duration
...
//!	@see Aurora::Addon::WebAPI::EventData::cover()
		protected $cover;
//!	@see Aurora::Addon::WebAPI::EventData::cover
...
//!	@see Aurora::Addon::WebAPI::EventData::simName()
		protected $simName;
//!	@see Aurora::Addon::WebAPI::EventData::simName
...
//!	@see Aurora::Addon::WebAPI::EventData::globalPos()
		protected $globalPos;
//!	@see Aurora::Addon::WebAPI::EventData::globalPos
...
//!	@see Aurora::Addon::WebAPI::EventData::eventFlags()
...
//!	@see Aurora::Addon::WebAPI::EventData::maturity()
		protected $maturity;
//!	@see Aurora::Addon::WebAPI::EventData::maturity
...
*/
		protected function __construct($eventID, $creator, $name, $description, $category, DateTime $date, $duration, $cover, $simName, Vector3 $globalPos, $eventFlags, $maturity){
			...
			}else if(preg_match(WebAPI::regex_UUID, $creator) != 1){
...
//!	Abstract iterator for instances of Aurora::Addon::WebAPI::EventData
...
*	@param array $parcels array of Aurora::Addon::WebAPI::EventData objects
*/
			...
			if(isset($parcels) === true){
				...
				foreach($parcels as $parcel){
					if($parcel instanceof EventData){
						...
						throw new InvalidArgumentException('Only instances of Aurora::Addon::WebAPI::EventData should be passed to Aurora::Addon::WebAPI::abstractSeekableEventDataIterator::__construct()');
					}
				}
			}
		}
...
//!	Return type iterator for Aurora::Addon::WebAPI::GetEvents()
...
*	@param mixed $parcels NULL or array array of Aurora::Addon::WebAPI::EventData objects
*/
		protected function __construct(WebAPI $WebAPI, $start=0, $total=0, array $filter=null, array $sort=null, array $parcels=null){
			$this->filter = $filter;
			$this->sort   = $sort;
...
*/
		public static function r(WebAPI $WebAPI, $start=0, $total=0, array $filter=null, array $sort=null, array $parcels=null){
			...
			if($create === true){
				$registry[$hash1][$hash2][$hash3] = new static($WebAPI, $start, $total, $filter, $sort, $parcels);
			}
...
//!	To avoid slowdowns due to an excessive amount of curl calls, we populate Aurora::Addon::WebAPI::GetEvents::$data in batches of 10
/**
...
*/
		public function current(){
			if($this->valid() === false){
				...
				$start   = $this->key();
				$results = $this->WebAPI->GetEvents($start, 10, $this->filter, $this->sort, true);
